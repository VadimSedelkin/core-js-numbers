...
function getAverage(value1, value2) {
  const bothNumbersAreOdd = value1 % 2 && value2 % 2;
  let average = Math.floor(value1 / 2) + Math.floor(value2 / 2);
  if (bothNumbersAreOdd) {
    average += 1;
  }
  return average;
}
...
function toNumber(value, def) {
  ...
  return typeof newValue === 'number' && newValue === +value ? newValue : def;
}
